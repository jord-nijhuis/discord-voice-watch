...
This Terms of Service Agreement (the "Agreement") is entered into between Jord Nijhuis ("Bot Owner") and the user ("User") of the Voice Watch Discord bot (the "Bot").
...
5. Intellectual Property: See the [LICENSE](LICENSE) file for information on the license of the Bot.
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of The Netherlands. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of [Your arbitration provider].
